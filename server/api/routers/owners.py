...
from server.domain.schemas import OwnerStatsOut, RequestOut, RequestType, RequestStatus
...
def list_my_requests(
    ...
    """
    try:
        return owner_service.get_my_requests(db=db, user_id=user_id, type=type, status=status)
    except Exception as e:
